const header = ({image})=>{
    return(
        <div className="lg:h-80 h-56 rounded-xl relative shadow-lg">
            <img className="h-full w-full object-cover rounded-xl " src={image? `https://api.castfilegh.com/${image}` :"https://cdn.pixabay.com/photo/2016/11/13/12/52/kuala-lumpur-1820944_1280.jpg"} alt="" />
