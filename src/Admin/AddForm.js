...
class Formclass extends React.Component{
    constructor(){
        super()
        this.state={ 
            BASE_URL: 'https://api.castfilegh.com/organiser',
            BASE_URL2: 'https://api.castfilegh.com/admin',
                        ...
                        <div className='col-span-2 lg:col-span-1 bg-blue-50 p-5 rounded-xl'>
                            ...
                            <div>
                               ...
                               <div>
                                    ...
                                    <div className='py-2'>
                                        <a className='bg-blue-100 border border-blue-500 text-blue-600 rounded-lg hover:bg-blue-500 hover:text-white p-1 px-2' href="https://api.castfilegh.com/public/List.xlsx">Download Sample</a>
                                    </div>
                               </div>
                            </div>: null}
